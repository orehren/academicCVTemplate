...
**Note:** For this tutorial, we assume you want to use all features. However, if you don't have a profile photo or don't want a cover letter, you can simply set these fields to `null` or remove them from the YAML.
